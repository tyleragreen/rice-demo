...
hdrdir = $(topdir)
arch_hdrdir = /usr/local/rvm/rubies/ruby-2.3.0/include/ruby-2.3.0/x86_64-linux
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby

prefix = $(DESTDIR)/usr/local/rvm/rubies/ruby-2.3.0
...
DEFS     = 
CPPFLAGS =   $(DEFS) $(cppflags)  -I/usr/local/rvm/gems/ruby-2.3.0/gems/rice-2.1.0/ruby/lib/include
CXXFLAGS = $(CFLAGS)  -Wall -g
ldflags  = -L. -fstack-protector -rdynamic -Wl,-export-dynamic  -L/usr/local/rvm/gems/ruby-2.3.0/gems/rice-2.1.0/ruby/lib/lib -lrice
dldflags =  
ARCH_FLAG = 
...
target_prefix = 
LOCAL_LIBS = 
LIBS = -Wl,-rpath,'${ORIGIN}/../lib' -Wl,-R'${ORIGIN}/../lib' -lruby -lpthread -lgmp -ldl -lcrypt -lm   -lc
ORIG_SRCS = test.cpp
SRCS = $(ORIG_SRCS) 
OBJS = test.o
HDRS = 
